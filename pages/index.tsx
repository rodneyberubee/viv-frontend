    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <div className="mt-10 flex justify-center">
            <div className="bg-gray-50 border rounded-lg shadow-lg p-8 w-full max-w-md">
              ...
              <p className="mt-4 text-4xl font-bold text-orange-500">$100 <span className="text-lg text-gray-600">/mo</span></p>
              <ul className="mt-6 space-y-2 text-gray-700">
                <li>✓ Unlimited reservations</li>
                <li>✓ AI-powered booking assistant</li>
                <li>✓ Host dashboard & reporting</li>
              </ul>
              <Link href="/signup" className="mt-6 inline-block bg-orange-500 text-white px-6 py-3 rounded shadow hover:bg-orange-600">
                Get Started
              </Link>
            </div>
          </div>
      ...
      <section id="contact" className="bg-gray-50 py-16">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <Link href="/contact" className="mt-6 inline-block bg-orange-500 text-white px-6 py-3 rounded shadow hover:bg-orange-600">
            Contact Us
          </Link>
        </div>
      </section>
